// The engine contract (business-simulator-v2-reconciler §4/§5): the typed
...
export interface ResourcePolicy {
  /** `retain` is the pinned superuser: teardown keeps the row. */
  prune: "delete" | "retain";
...
export type OperationType =
  "create" | "update" | "patch" | "replace" | "delete" | "demote" | "promote";
