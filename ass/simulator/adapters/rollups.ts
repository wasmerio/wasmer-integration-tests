...
// feeds it has finished. Getting this order wrong is the double-count the
// retired seeder's post-mortem describes, so it lives in one place with
// one entry point.
//
...
import { SIM_NODE_UUID } from "./inserts";
