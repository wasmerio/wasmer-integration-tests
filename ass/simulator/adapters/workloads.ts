...
import { insertWorkloadSummaries, SIM_NODE_UUID } from "./inserts";
...
/** Gauge samples: six per hour, the shape the instance view reads. They
 * belong to the hour they sample, so they are written with it. */
